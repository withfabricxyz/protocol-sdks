// Generated by @wagmi/cli@1.3.0 on 10/26/2023 at 8:04:36 AM
import {
  getContract,
  GetContractArgs,
  writeContract,
 ...
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x19ead00ce8961cffca0551244dc07d87e6ff8f7e)
 ...
 * - [__View Contract on Zora Zora__](https://explorer.zora.co/address/0xf53e3729aC1caDd24D5986b2738D0DEE5f4eD30A)
 ...
 */
export function watchSubscriptionTokenV1Event<
  TAbi extends readonly unknown[] = typeof subscriptionTokenV1ABI,
  TEventName extends string = string,
>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, 'abi'>,
  ...
  return watchContractEvent(
    { abi: subscriptionTokenV1ABI, ...config } as WatchContractEventConfig<
      TAbi,
      TEventName
    >,
    callback,
 ...
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xAAe8931adbF1DFC227B2f2eB619450c4fd5E3323)
 */
export function watchSubscriptionTokenV1FactoryEvent<
  TAbi extends readonly unknown[] = typeof subscriptionTokenV1FactoryABI,
  TEventName extends string = string,
>(
  config: Omit<
